...
import '../network/api_details.dart';

class DetailMovieScreen extends StatefulWidget {
  DetailMovieScreen({super.key, required this.id});
  final int id;
...
class _DetailMovieScreenState extends State<DetailMovieScreen> {
  ...
  Widget getRaking(double voteAverage, int vote_count) {
